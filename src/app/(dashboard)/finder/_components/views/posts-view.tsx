    ...
    <div className="p-8 space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Manage your job and project posts</p>
        </div>
        <Button onClick={onCreatePost} size="lg">
          Create New Post
        </Button>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {filteredPosts.map((post) => (
          <PostCard key={post.id} post={post} categoryColor={getCategoryColor(post.type)} formatType={formatType} />
        ))}
      </div>
        ...
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-12">
            <div className="text-center">
              ...
              <p className="text-muted-foreground mb-4">Start by creating your first post</p>
